...
const copyCodeToClipboard = () => {
  if (editorRef.current) {
    ...
    const formattedCode = prettier.format(codeWithoutComments, { parser: 'babel' });
    const textValueset = document.querySelector('textarea');
    textValueset.textContent = formattedCode;

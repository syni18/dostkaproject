...
import { Code2, Braces,Pencil } from 'lucide-react';
import './App.css'
  ...
  return (
    <div className="App">
      ...
      <div className="change_btn">
        <button onClick={() => setFilename("index.html")}><Code2 size={18} id=''/>HTML</button>
        <button onClick={() => setFilename("index.css")}><Pencil size={18}/>css</button>
        <button onClick={() => setFilename("script.js")}><Braces size={18}/>Javascript</button>
